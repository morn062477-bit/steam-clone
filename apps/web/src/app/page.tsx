...
export default function Home() {
  ...
  const [view, setView] = useState<"store" | AuthView | "game" | "cart" | "wishlist" | "category" | "deals">("store");
  ...
  useEffect(() => {
    const OF_HASH: Record<string, "store" | AuthView | "game" | "cart" | "wishlist" | "category" | "deals"> = {
      "#login": "login", "#signup": "signup", "#create": "create", "#verified": "done",
      "#cart": "cart", "#wishlist": "wishlist", "#deals": "deals",
    };
    function applyHash() {
  ...
  function goView(v: "store" | AuthView | "game" | "cart" | "wishlist" | "category" | "deals", e?: React.MouseEvent) {
    e?.preventDefault();
